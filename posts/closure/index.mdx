...
export const CounterComp = () => {
  ...
  return (
    <>
      <div className="flex h-20 items-center">
        <span>{count}</span>
        <button onClick={() => setCount(2)}>点我</button>
      </div>
      <div className="flex gap-4">
        <button className="rounded bg-blue-500 p-2" onClick={() => Counter().increment()}>
          点我+1
        </button>
        <button className="rounded bg-blue-500 p-2" onClick={() => Counter().decrement()}>
          点我-1
        </button>
        <button className="rounded bg-blue-500 p-2" onClick={() => setCount(Counter().value())}>
          点我更新数据
        </button>
      </div>
    </>
